...
class robot_2Request {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type robot_2Request
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type robot_2Request
    let len;
    let data = new robot_2Request(null);
  ...
  static datatype() {
    ...
    return 'system_package/robot_2Request';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_2Request(null);
...
class robot_2Response {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type robot_2Response
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type robot_2Response
    let len;
    let data = new robot_2Response(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_2Response(null);
...
module.exports = {
  Request: robot_2Request,
  Response: robot_2Response,
  md5sum() { return 'a78760cc430dc3134f2177ea1154f152'; },
  datatype() { return 'system_package/robot_2'; }
};
